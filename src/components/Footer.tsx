  ...
  return (
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <h3 className="text-lg font-bold mb-2">Інформація</h3>
          <ul>
            <li>Статті</li>
        ...
        <div className="mb-4 md:mb-0">
          ...
          <p>Пн – Нд: з 10:00 до 19:00</p>
          <p>Без вихідних</p>
          <p>Київ, проспект Мира, 2/3</p>
          <p>Київ, проспект Воздушних Сил, 7</p>
          <p>Київ, площа Оболонська, 1</p>
        </div>
        <div className="mb-4 md:mb-0">
          <h3 className="text-lg font-bold mb-2">Зв'язок з нами</h3>
          <p>044 338-43-43</p>
          <p>044 333-94-43</p>
          <p>066 354-43-43</p>
          <p>063 352-43-43</p>
          <p>067 345-43-43</p>
          <h3 className="text-lg font-bold mt-4 mb-2">Графік роботи колл-центру</h3>

          <p>Пн – Вс: с 10:00 до 19:00</p>
        </div>
        <div>
          <h3 className="text-lg font-bold mb-2">Підписатися на новини</h3>
  ...
  <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="24" fill="currentColor">
      ...
      <div className="container mx-auto mt-8 text-center text-gray-400">
        &copy; 2024 Fitgear - інтернет-магазин з продажу спортивного харчування. Ми доставляємо спортивне харчування також до міст: Київ, Харків, Дніпро, Львів, Івано-Франківськ, Чернівці, Тернопіль, Хмельницький, Вінниця, Чернігів, Житомир, Черкаси, Кропивницький, Одеса, Миколаїв, Запоріжжя, Суми, Рівне, Полтава, Ужгород та інші міста України.
      </div>
